...
class LikeMessageOverlay extends StatefulWidget {
  const LikeMessageOverlay({Key? key, required this.messageCount,required this.followerCount, this.glassColor=Colors.black87,this.boxShadow=Colors.black87}) : super(key: key);
